...
class Controller_Importquotes extends Controller {
	...
	public function action_index()
	{
		...
		if($model->getNumQuotes($_GET['currency'],$_GET['date'])==0){ 		
			...
			DB::query(Database::UPDATE, "UPDATE room_w1 SET high='".$_GET['high']."', low='".$_GET['low']."', open='".$_GET['open']."', close='".$_GET['close']."', volume='".$_GET['volume']."' WHERE  date='".$_GET['date']."' and currency='".$_GET['currency']."' LIMIT 1");
		}
